...
export default function CustomerDetailPage() {
  ...
  useEffect(() => {
    fetch(`/api/customers/${params.id}`).then((r) => r.json()).then((d) => {
      ...
      fetch(`/api/subscriptions?limit=100`).then((r2) => r2.json()).then((subs) => {
