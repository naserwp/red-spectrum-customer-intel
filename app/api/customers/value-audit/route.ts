...
export async function GET(request: Request) {
  ...
  const [wooOrders, authorizeNetTransactions, nmiTransactions, stripeTransactions, subscriptions] = await Promise.all([
  ...
  const metrics = calculateCustomerValueMetrics({ customer, wooOrders, authorizeNetTransactions, nmiTransactions, stripeTransactions, subscriptions });
